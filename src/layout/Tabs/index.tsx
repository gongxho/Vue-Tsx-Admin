...
export default defineComponent({
	...
	setup() {
		...
		// 全屏
		const onFullscreen = () => store_app.contentFullScreenChange(!contentFullScreen.value);
			...
			<div class="tabs">
				<el-scrollbar class="scroll-container tags-view-container" ref={scrollbarDom} onScroll={handleScroll}>
					{menuList.value.map((menu: any) => (
						<Item key={menu.meta.title} menu={menu} active={activeMenu.path === menu.path} onClose={() => delMenu(menu)} onReload={pageReload} />
					))}
				</el-scrollbar>
				<div class="handle">
					<el-dropdown
					...
					<el-tooltip class="item" effect="dark" content={contentFullScreen ? 'fullScreenBack' : 'fullScreen'} placement="bottom">
