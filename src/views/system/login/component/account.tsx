		...
		return () => (
			<el-form model={state.ruleForm} rules={rules} ref={ruleFormRef} size="large" class="login-content-form">
				...
				<el-form-item class="login-animation2" prop="password">
					<el-input
						...
						v-slots={{
							...
							suffix: () => (
								<el-icon onClick={() => (state.isShowPassword = !state.isShowPassword)}>{state.isShowPassword ? <View /> : <Hide />}</el-icon>
							),
						}}
					></el-input>
				</el-form-item>
				...
				<el-form-item class="login-animation4">
					<el-button type="primary" class="login-content-submit" round onClick={() => submit(ruleFormRef.value)} loading={state.loading.signIn}>
						<span>登录</span>
					</el-button>
				</el-form-item>
			</el-form>
