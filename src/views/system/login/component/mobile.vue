<template>
	<el-form size="large" class="login-content-form">
		<el-form-item class="login-animation1">
			<el-input type="text" placeholder="placeholder1" v-model="ruleForm.userName" clearable autocomplete="off">
				<template #prefix>
		...
		<el-form-item class="login-animation2">
			<el-col :span="15">
				<el-input type="text" maxlength="4" placeholder="placeholder2" v-model="ruleForm.code" clearable
					autocomplete="off">
					<template #prefix>
						<el-icon>
							<Position />
