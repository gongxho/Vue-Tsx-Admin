	...
	setup(porps, { expose }) {
		...
		return () => (
			<div class="system-add-dic-container">
				...
				>
					<el-alert title="半成品，交互过于复杂，请自行扩展！" type="warning" closable={false} class="mb20">
						{' '}
					</el-alert>
										...
										<>
											<el-row gutter={35} key={k}>
												<el-col xs={24} sm={12} md={12} lg={12} xl={12} class="mb20">
													<el-form-item
														...
														v-slots={{
															label: () => (
																<div>
																	{k == 0 ? (
																		<el-button type="primary" circle size="small" onClick={onAddRow}>
																			<el-icon>
																				<Plus />
																			</el-icon>
																		</el-button>
																	) : (
																		<el-button type="danger" circle size="small" onClick={() => onDelRow(k)}>
																			<el-icon>
																				<Delete />
																			</el-icon>
																		</el-button>
													...
													>
														<el-input v-model={v.label} style="width: 100%" placeholder="请输入字段名">
															{' '}
														</el-input>
													</el-form-item>
												</el-col>
												<el-col xs={24} sm={12} md={12} lg={12} xl={12} class="mb20">
													<el-form-item label="属性" prop={`list[${k}].value`}>
														<el-input v-model={v.value} style="width: 100%" placeholder="请输入属性值">
															{' '}
														</el-input>
													</el-form-item>
												</el-col>
